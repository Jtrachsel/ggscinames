...
#' }
geom_text_sciname <- function(mapping = NULL, data = NULL,
...
#' @usage NULL
#' @export
GeomTextSciname <- ggproto("GeomTextSciname", Geom,
                    required_aes = c("x", "y"),

                    default_aes = aes(
                      colour = "black", size = 3.88, angle = 0, hjust = 0.5,
                      vjust = 0.5, alpha = NA, family = "", fontface = 1, lineheight = 1.2,
                      sci=NULL, nonsci=NULL, important=NULL
                    ),

                    draw_panel = function(data, panel_params, coord, parse = TRUE,
                      ...
                      # data$fontface <- ifelse(data$important, 2, 1)
